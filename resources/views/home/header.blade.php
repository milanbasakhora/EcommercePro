<header class="header_section">
    <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
            <a class="navbar-brand" href="home/index.html"><img width="250" src="home/images/logo.png"
                    alt="#" /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="home/#" data-toggle="dropdown" role="button"
                    ...
                    @if (Route::has('login'))
                        ...
                        @else
                            <li>
                                <a class="btn btn-primary" id="logincsss" href="{{ route('login') }}">Login</a>
                            </li>
                            <li>
